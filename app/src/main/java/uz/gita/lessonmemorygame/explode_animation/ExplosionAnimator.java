package uz.gita.lessonmemorygame.explode_animation;
...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = tyrantgit.explosionfield.Utils.dp2Px(5);
    private static final float Y = tyrantgit.explosionfield.Utils.dp2Px(20);
    private static final float V = tyrantgit.explosionfield.Utils.dp2Px(2);
    private static final float W = tyrantgit.explosionfield.Utils.dp2Px(1);
